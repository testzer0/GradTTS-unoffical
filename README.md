...
$$ \mathcal{L}\vphantom_{diff} = \mathbb{E}\vphantom_{X_0,t}\left[\lambda_t\mathbb{E}\vphantom_{\xi_t}\left[\left|\left|s_\theta(X_t,\mu,t)+\frac{\xi_t}{\sqrt{\lambda_t}}\right|\right|\right]\right] $$
